...
2. `context/web-screens.md` (the screen list for the current phase, including Employee Self-Service)
...
6. **Visual verification.** Run the dev server and confirm each screen renders. Iterate until the user approves the look.
...
|---|---|
| P0 | Login, tenant onboarding, dashboard shell, branch switcher, audit log viewer, Employee Self-Service entry shell |
...
| P6 | Manager self-service pages; Employee Self-Service (web) full (profile, clock, leave, payslip, benefits, goals, docs) |
